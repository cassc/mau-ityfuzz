...
#define WARNF(x...) do { \
    SAYF(cYEL "[!]@librunner.so: " cBRI "WARNING: " cRST x); \
    SAYF(cRST "\n"); \
  } while (0)
...
// size_t BytesToHex(uint8_t In[], const size_t Size, uint8_t Out[]);
